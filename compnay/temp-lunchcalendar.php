...
?>
    <div class='panels'>
        <div class='panel launchClander'>
            ...
            <h2><?php _e('Business lunch calendar','text_domain'); ?></h2>
            <p><?php _e('Here you can easily choose between or cancel the various lunch options from day to day. ','text_domain'); ?>
            </p>
